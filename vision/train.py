...
def train(model, optimizer, loss_fn, dataloader, metrics, params):
    ...
    with tqdm(total=len(dataloader)) as t:
        for i, (train_batch, labels_batch) in enumerate(dataloader):
            ...
            if outputs is None:
                ...
                # logging.info('output_batch: ' + str(output_batch.data.shape))
    ...
    pd.DataFrame(outputs).to_csv('outputs/train_predictions.csv')
    pd.DataFrame(labels).to_csv('outputs/train_labels.csv')
    return metrics_mean
...
def train_and_evaluate(model, train_dataloader, val_dataloader, optimizer, loss_fn, metrics, params, model_dir,
    ...
    for epoch in range(params.num_epochs):
        ...
        with open('outputs/train_metrics_list.pkl', 'wb') as f:
            pickle.dump(train_metrics_list, f)
        with open('outputs/val_metrics_list.pkl', 'wb') as f:
